...
/*
  ...
  hint: you'll need to do some multiplication). Your answer should 
  be an array of numbers, one total for each order.
*/

// CODE HERE
const orderTotals = (el, i, arr) => el.price * (1 + el.tax);
console.log(orders.map(orderTotals));
...
// CODE HERE
const bobsTotal = (el, i, arr) => el.owner === "Bob";
console.log(purchases.filter(bobsTotal));
